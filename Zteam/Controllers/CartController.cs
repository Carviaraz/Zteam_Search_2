...
namespace Zteam.Controllers
{
    public class CartController : Controller
    {
        ...
        public IActionResult AddDtl(string Gameid)
        {
            //ตรวจสอบ Login??
